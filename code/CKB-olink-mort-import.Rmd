...
# load olink data
cardio_olink <- read.csv("/Users/aargenti/Documents/proteomic_age/data/ckb/DAR-2023-00293-V1/data_baseline_olink_cardiometabolic.csv")
inflamm_olink <- read.csv("/Users/aargenti/Documents/proteomic_age/data/ckb/DAR-2023-00293-V1/data_baseline_olink_inflammation.csv")
neuro_olink <- read.csv("/Users/aargenti/Documents/proteomic_age/data/ckb/DAR-2023-00293-V1/data_baseline_olink_neurology.csv")
onco_olink <- read.csv("/Users/aargenti/Documents/proteomic_age/data/ckb/DAR-2023-00293-V1/data_baseline_olink_oncology.csv")
...
```{r questionnaire_dat}
# olink <- read.csv("K:/CKB-exposome/For_Austin/olink_data/data_baseline_olink.csv")
...
ascertainment <- read.csv("/Users/aargenti/Documents/proteomic_age/data/ckb/DAR-2023-00293-V1/data_baseline_ascertainments.csv")
...
# save csv
write.csv(olink_dat, row.names = FALSE, file = "/Users/aargenti/Documents/proteomic_age/data/ckb/ckb_coded_olink_oct_17_2023.csv")
